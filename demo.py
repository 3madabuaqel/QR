...
class EntryField(ctk.CTkFrame):
    def __init__(self, parent, entry_string, save_func):
        super().__init__(master = parent,corner_radius=20,fg_color='#ffffff')
        ...
        btn = ctk.CTkButton(self.frame, text='save', fg_color='#2E54E8', hover_color='#4266F1', command=lambda:save_func(''))
        btn.grid(row=0, column=2 ,sticky='nsew', padx=10) 
